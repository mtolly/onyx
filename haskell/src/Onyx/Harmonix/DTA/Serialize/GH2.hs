...
module Onyx.Harmonix.DTA.Serialize.GH2 where
...
import           Onyx.Codec.Common                    (enumCodec, opt, req)
import           Onyx.Harmonix.DTA
import           Onyx.Harmonix.DTA.Serialize
import           Onyx.Harmonix.DTA.Serialize.RockBand (AnimTempo, channelList)
import           Onyx.MIDI.Common                     (each)
import           Onyx.MIDI.Read                       (reprPrefix)
