...
runMagmaMIDI :: (MonadUnliftIO m) => FilePath -> FilePath -> StackTraceT m String
...
runMagma :: (MonadUnliftIO m) => FilePath -> FilePath -> StackTraceT m String
...
runMagmaV1 :: (MonadUnliftIO m) => FilePath -> FilePath -> StackTraceT m String
...
oggToMogg :: (MonadUnliftIO m) => FilePath -> FilePath -> StackTraceT m ()
