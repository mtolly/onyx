...
runMagmaMIDI :: (SendMessage m, MonadIO m) => FilePath -> FilePath -> StackTraceT m String
...
runMagma :: (SendMessage m, MonadIO m) => FilePath -> FilePath -> StackTraceT m String
...
runMagmaV1 :: (SendMessage m, MonadIO m) => FilePath -> FilePath -> StackTraceT m String
...
oggToMogg :: (SendMessage m, MonadIO m) => FilePath -> FilePath -> StackTraceT m ()
